...
const style = {
  ...
  headerItem: `text-white px-4 font-bold text-[#ffffff] hover:text-[#FEE34B] cursor-pointer`,
  headerIcon: `text-[#ffffff] text-3xl font-black px-4 hover:text-[#FEE34B] cursor-pointer`,
}
